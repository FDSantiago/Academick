...
export default function EditUserForm({ user, onSuccess, onError, onCancel }: Props) {
    const page = usePage();
    ...
    async function submit(e: React.FormEvent) {
        ...
        try {
            ...
            const res = await axios.put(`/api/admin/users/${user.id}`, form.data);
            ...
            // other errors
            onError?.(json || { message: 'Failed to update user' });
        } catch (err: any) {
